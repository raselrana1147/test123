...
@section('title',config('constant.company_name').' Create Agency')
@section('main')
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form id="submit_form" data-action="{{ route('agency.store') }}" method="post" >
                      @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Agency Name<i class="icofont icofont-info-circle" title="Required"></i></label>
                            <div class="col-sm-10">
