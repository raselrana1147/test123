	          ...
	          <div class="row gx-5 align-items-center">
	              <div class="col-lg-6">
	                  <div class="about-img-wrap">
	                      <img src="{{ asset('assets/frontend/assets/img/about/about-img-1.jpg') }}" alt="Image" class="about-img-one">
	                      <img src="{{ asset('assets/frontend/assets/img/about/about-img-2.jpg')}}" alt="Image" class="about-img-two">
	                      <div class="about-doctor-box">
	                          <div class="doctor-img">
	                              <img src="{{ asset('assets/frontend/assets/img/about/doctor-1.jpg')}}" alt="Image">
	                          </div>
	              ...
	              <div class="col-lg-6">
	                  <div class="about-content">
	                      ...
	                      <div class="ceo-msg">
	                          <div class="ceo-img">
	                              <img src="{{ asset('assets/frontend/assets/img/about/doctor-2.jpg')}}" alt="Image">
	                          </div>
	          ...
	          <div class="testimonial-slider-two owl-carousel">
	                  ...
	                  <div class="client-info-area">
	                      <div class="client-info-wrap">
	                          <div class="client-img">
	                              <img src="{{ asset('assets/frontend/assets/img/testimonials/client-1.jpg')}}" alt="Image">
	                          </div>
	              ...
	              <div class="testimonial-card style2">
	                  <div class="client-info-area">
	                      <div class="client-info-wrap">
	                          <div class="client-img">
	                              <img src="{{ asset('assets/frontend/assets/img/testimonials/client-2.jpg')}}" alt="Image">
	                          </div>
	                          <div class="client-info">
	                              <h3>Alex Cruis</h3>
	                              <span>CEO, IBAC</span>
	              ...
	              <div class="testimonial-card style2">
	                  <div class="client-info-area">
	                      <div class="client-info-wrap">
	                          <div class="client-img">
	                              <img src="{{ asset('assets/frontend/assets/img/testimonials/client-3.jpg')}}" alt="Image">
	                          </div>
	                          <div class="client-info">
	                              <h3>Tom Haris</h3>
	              ...
	              <div class="testimonial-card style2">
	                  <div class="client-info-area">
	                      <div class="client-info-wrap">
	                          <div class="client-img">
	                              <img src="{{ asset('assets/frontend/assets/img/testimonials/client-4.jpg')}}" alt="Image">
	                          </div>
	                          <div class="client-info">
	                              <h3>Harry Jackson</h3>
	              ...
	              <div class="testimonial-card style2">
	                  <div class="client-info-area">
	                      <div class="client-info-wrap">
	                          <div class="client-img">
	                              <img src="{{ asset('assets/frontend/assets/img/testimonials/client-5.jpg')}}" alt="Image">
	                          </div>
	                          <div class="client-info">
	                              <h3>Chris Haris</h3>
	                              <span>MD, ITec</span>
	  ...
	  <div class="container  pb-100">
	      <div class="partner-slider-one owl-carousel">
	          <div class="partner-item">
	              <img src="{{ asset('assets/frontend/assets/img/partner/partner-7.png')}}" alt="Image">
	          </div>
	          <div class="partner-item">
	              <img src="{{ asset('assets/frontend/assets/img/partner/partner-8.png')}}" alt="Image">
	          </div>
	          <div class="partner-item">
	              <img src="{{ asset('assets/frontend/assets/img/partner/partner-9.png')}}" alt="Image">
	          </div>
	          <div class="partner-item">
	              <img src="{{ asset('assets/frontend/assets/img/partner/partner-10.png')}}" alt="Image">
	          </div>
	          <div class="partner-item">
	              <img src="{{ asset('assets/frontend/assets/img/partner/partner-11.png')}}" alt="Image">
	          </div>
	          <div class="partner-item">
	              <img src="{{ asset('assets/frontend/assets/img/partner/partner-12.png')}}" alt="Image">
	          </div>
	      </div>
	  </div>
	  <!-- Partner Area End -->
