...
shutter.src = navigator.userAgent.match(/Firefox/) ? asset('assets/backend/plugin/shutter.ogg') : asset('assets/backend/plugin/shutter.mp3');
...
function take_snapshot()
{
    ...
    Webcam.snap(function(data_uri) {
      ...
      $('#preview_image_my').html('<img src="' + data_uri + '" style="width:100px;height:60px;float:left" class="d-block mx-auto rounded"/>');
